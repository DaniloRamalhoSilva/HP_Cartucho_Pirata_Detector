...
def scrap_product(url, driver):
    try:
        ...
        product_reviews = driver.find_element(By.CSS_SELECTOR, "h2.ui-review-capability__header__title")
        if (product_reviews):
        ...
        seller = seller.text.split('Vendido por ')
        ...
        if (show_more):
            ...
            if comments:
                ...
                for comment in comments:
                    comentario = driver.find_element(By.CSS_SELECTOR, 'div.ui-review-capability-comments div')
                    rating = comentario.find_element(By.CSS_SELECTOR, 'p.andes-visually-hidden').text
                    review_date = comentario.find_element(By.CSS_SELECTOR, 'span.ui-review-capability-comments__comment__date').text
                    review = comentario.find_element(By.CSS_SELECTOR, 'p.ui-review-capability-comments__comment__content').text
